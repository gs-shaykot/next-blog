...
export async function POST(req) {
    try {
        ...
        const systemInstruction = `You are a professional blog content creator. Write a high-quality, engaging, and well-structured blog post. The tone must be ${tone} and the length must be approximately ${length} words. Use appropriate markdown (##, ###, lists) for formatting.`;
