...
export default function LatestPosts({ latestPosts }) {
    ...
    return (
        <div className={`${themeMode === "dark" ? "bg-gray-900" : "bg-white"}`}>
            <div className={`max-w-7xl mx-auto px-5 py-10 ${themeMode === "dark" ? "!text-white" : "!text-black"}`}>
                ...
                <div className="w-full flex justify-center items-center  mt-16">
                    <Link href='/blogs'>
                        <button
                            className='cursor-pointer px-4 py-2 bg-gradient-to-r from-blue-600 hover:from-blue-700 to-indigo-700 hover:to-indigo-800 text-white transform hover:scale-105 transition duration-200 rounded-md shadow-lg'>
                            View All Posts →
                        </button>
                    </Link>
                </div>
